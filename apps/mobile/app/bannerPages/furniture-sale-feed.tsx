...
export default function FurnitureSaleFeedPage() {
    const { layout: pageData, loading, error } = usePageLayout('furniture-sale-feed');

    if (loading) {
        return (
            <View style={styles.center}>
                <ActivityIndicator size="large" color="#52665F" />
            </View>
        );
    }
