...
interface FoodAndHealthPageProps {
    staticHeader?: React.ReactNode;
    renderStickyHeader?: (isSticky: boolean) => React.ReactNode;
}

export default function FoodAndHealthPage({ staticHeader, renderStickyHeader }: FoodAndHealthPageProps) {
    ...
    const categoryId = '695ff7de3f61939001a06385';
