...
interface TwoWheelersPageProps {
    staticHeader?: React.ReactNode;
    renderStickyHeader?: (isSticky: boolean) => React.ReactNode;
}

export default function TwoWheelersPage({ staticHeader, renderStickyHeader }: TwoWheelersPageProps) {
