...
interface AutoAccessoriesPageProps {
    staticHeader?: React.ReactNode;
    renderStickyHeader?: (isSticky: boolean) => React.ReactNode;
}

export default function AutoAccessoriesPage({ staticHeader, renderStickyHeader }: AutoAccessoriesPageProps) {
    ...
    const categoryId = '695ff7de3f61939001a06384';
