...
// ============================================================================
// FURNITURE LAYOUT (Isolated Seed Script)
// ============================================================================
...
async function seedFurnitureLayout() {
    ...
    try {
        ...
        // Delete existing layout to avoid duplicates/merging issues
        await collection.deleteOne({ pageSlug: 'furniture' });

        // Insert exact confirmed layout
        await collection.insertOne(furnitureLayout);

        console.log("✅ Furniture Layout Seeded Successfully (Exact Restoration)");
