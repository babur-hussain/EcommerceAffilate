                ...
                <div className="max-w-[1440px] mx-auto px-3 sm:px-4 md:px-6 pt-3 sm:pt-4 pb-2 mb-0">
                    <div className="flex items-center justify-between gap-2 sm:gap-4 md:gap-8 h-full">
                        ...
                        <Link href="/" className="flex items-center gap-2 group shrink-0">
                            ...
                            <h1 className="text-xs xs:text-sm sm:text-lg md:text-xl font-bold tracking-tight text-[#023047] leading-tight truncate max-w-[120px] xs:max-w-[160px] sm:max-w-none">
                        ...
                        <div className="flex items-center gap-2 sm:gap-3 md:gap-6">
                            ...
                            <button
                                ...
                                className="md:hidden flex items-center justify-center size-10 min-w-[40px] text-slate-500 hover:text-slate-900 transition-colors"
                            >
                            ...
                            <div className="relative" onMouseLeave={() => setCartOpen(false)}>
                                <button
                                    ...
                                    className="relative flex items-center justify-center size-10 bg-accent text-[#023047] rounded-full shadow-lg hover:bg-accent-dark text-white transition-colors group"
                                >
                                    <span className="material-symbols-outlined text-[20px]">
                                        shopping_cart
                                    </span>
                            ...
                            {isLoggedIn ? (
                                ...
                                <div className="flex items-center gap-2">
                                    <button
                                        ...
                                        className="hidden sm:inline-flex px-3 py-1.5 text-sm font-bold text-[#023047] hover:text-primary transition-colors"
                                    >
                                        Log in
                                    </button>
                                    <button
                                        onClick={() => openAuth("signup")}
                                        className="px-3 sm:px-4 py-2 bg-[#023047] text-white text-xs sm:text-sm font-bold rounded-full hover:bg-accent hover:text-[#023047] hover:shadow-lg transition-all"
                                    >
                                        Join
                                    </button>
                                </div>
